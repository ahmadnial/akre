...
?>
                            ...
                            <header>
                                <div class="container bg-success text-white mb-3 col-7 text-center shadow-lg p-2 mb-2 bg-body rounded">
                                    <h1>GATAU KEPANJANGANNYA <b>(ARK)</b></h1>
                                </div>
                            </header>
  ...
  -->
                  ...
                  <tr>
                    ...
                    <td><div class="btn-group" role="group" aria-label="Basic mixed styles example">
                        ...
                        <form method="GET">
                            <button type="button" data-toggle="modal" data-target="#" value="View PDF" name="getdetail" onclick="goToURL()" class="btn btn-success">View</button>
                        </form>
                    </div></td>
                  </tr>
                  <?php
                        ...
                        include '../../conn.php';
                        $query    =sqlsrv_query($conn, "SELECT * FROM ark WHERE id_file='$id_karyawan'");
